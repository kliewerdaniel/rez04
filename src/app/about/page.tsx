...
export default function AboutPage() {
  ...
  const keyProjects = [
    {
      name: 'GhostWriter - AI-Powered Writing Assistant',
      type: 'Open-Source Project',
      year: '2024',
      description: 'Developed intelligent writing companion using local LLM integration for content generation and editing assistance',
      details: [
        'Implemented privacy-first architecture with local processing to ensure user data sovereignty',
        'Created modular system supporting various writing domains including blogging, marketing, and technical documentation',
        'Built with React/Next.js frontend and Python backend for seamless user experience'
      ]
    },
    {
      name: 'PersonaGen - Advanced Persona-Based AI Framework',
      type: 'System Architect',
      year: '2024',
      description: 'Designed comprehensive JSON schema defining 25 psychological and personality traits for AI persona modeling',
      details: [
        'Integrated Reinforcement Learning (RL) and Retrieval-Augmented Generation (RAG) for contextual AI responses',
        'Developed graph-based orchestration system for complex multi-agent interactions',
        'Applied system to Reddit data analysis and academic text processing for stylistic assessment'
      ]
    },
    {
      name: 'AI-Powered Journaling Platform',
      type: 'Lead Developer',
      year: '2024 – Present',
      description: 'Built full-stack journaling application with real-time psychological analysis using local LLMs',
      details: [
        'Implemented SQLite and ChromaDB for efficient data storage and semantic search capabilities',
        'Created transparent AI feedback system with traceable commentary generation',
        'Deployed on Netlify with Next.js for optimal performance and scalability'
      ]
    },
    {
      name: 'Open Deep Research Framework',
      type: 'Developer',
      year: '2025',
      description: 'Engineered comprehensive research automation system using SmolAgents',
      details: [
        'Implemented multi-step data collection, analysis, and synthesis workflows',
        'Created modular architecture for scalable research operations',
        'Integrated with local LLM infrastructure for privacy-preserving research capabilities'
      ]
    },
    {
      name: 'Reddit Diss Track Generator - LoCo Hackathon',
      type: 'Organizer & Lead Engineer',
      year: 'February 2025',
      description: 'Hosted successful local-LLM hackathon promoting AI independence and community collaboration',
      details: [
        'Developed agentic framework for Reddit thread scraping and structured data annotation',
        'Implemented multi-model workflow orchestration for automated content synthesis',
        'Integrated text-to-speech capabilities for complete audio production pipeline'
      ]
    }
  ];
  ...
  const experiences = [
    ...
    },
    {
      ...
      achievements: [
        'Created websites including danielkliewer.com, kadaligogh.com, and eastsidechess.org',
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400">
            Computer scientist specializing in AI-driven full-stack development and system design.
          </p>
        </div>
            ...
            <section className="mb-12">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Innovative AI developer and system architect specializing in local-first AI solutions, agentic reasoning frameworks,
                  and open-source infrastructure. Expert in building transparent, privacy-focused machine learning systems with extensive
                  experience in data annotation, LLM development, and full-stack application design. Proven track record of creating
                  production-ready AI applications that prioritize user autonomy and data sovereignty.
                </p>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  I am a computer scientist and full-stack developer focused on AI-first architectures and dependable software.
